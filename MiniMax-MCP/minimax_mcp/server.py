...
@mcp.tool(
    ...
    Args:
        ...
        vol (float, optional): Volume of the generated audio. Controls the volume of the generated speech. Values range from 0 to 10, with 5 being the default volume.
